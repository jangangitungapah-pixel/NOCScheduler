    ...
    <main className="ds-page">
      ...
      <section className="ds-section" aria-labelledby="tokens-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="tokens-title">
              Token & surfaces
            </h2>
            <p className="ds-section__description">
              Semantic roles, bukan raw color di feature page.
            </p>
          </div>
        </div>
        <div className="ds-grid">
          ...
          <div className="ds-card">
            ...
            <div className="ds-stack">
              <Surface elevation="subtle" padding="sm">
                Subtle / E0
              </Surface>
      ...
      <section className="ds-section" aria-labelledby="actions-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="actions-title">
              Actions & status
            </h2>
            <p className="ds-section__description">
              State visual konsisten tanpa membuat destructive action terlalu dominan.
            </p>
          </div>
        </div>
        <div className="ds-grid">
          <div className="ds-card ds-card--wide">
            ...
            <div className="ds-row">
              <Button leadingIcon={<Icon name="plus" size={16} />} variant="primary">
                Buat jadwal
              </Button>
              <Button variant="secondary">Review</Button>
              <Button variant="tonal">Validate</Button>
              <Button variant="ghost">Batal</Button>
              <Button leadingIcon={<Icon name="trash" size={16} />} variant="destructive">
                Hapus
              </Button>
              ...
              <Tooltip content="Aksi icon-only tetap punya accessible label.">
                <Button aria-label="Opsi lainnya" iconOnly variant="secondary">
      ...
      <section className="ds-section" aria-labelledby="forms-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="forms-title">
              Form family
            </h2>
            <p className="ds-section__description">
              Persistent labels, helper text, focus, error, disabled, dan searchable selection.
            </p>
          </div>
        </div>
        <div className="ds-grid">
          <div className="ds-card ds-card--wide">
            <div className="ds-form-grid">
              ...
              />
              <Input
                error="Nominal harus lebih besar dari Rp0."
                label="Incentive"
            ...
            <div style={{ marginTop: "var(--space-4)" }}>
              <Textarea
                helperText="Alasan disimpan sebagai bagian dari business history."
                label="Reason"
      ...
      <section className="ds-section" aria-labelledby="layers-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="layers-title">
              Contextual layers
            </h2>
            <p className="ds-section__description">
              Discoverable actions tetap tersedia; gesture/context menu hanya enhancement.
            </p>
          </div>
        </div>
        <div className="ds-grid">
          <div className="ds-card ds-card--full">
            <div className="ds-row">
              <Popover
                trigger={
                  <Button trailingIcon={<Icon name="chevron-down" size={16} />}>Popover</Button>
                }
              >
                <strong>Coverage context</strong>
                <p style={{ marginBottom: 0, color: "var(--text-secondary)" }}>
                  S3 memiliki 2 personel efektif dari target 3.
                </p>
              </Popover>
              <DropdownMenu
                ...
                trigger={
                  <Button trailingIcon={<Icon name="chevron-down" size={16} />}>Dropdown</Button>
                }
              />
              <ContextMenu
                items={[
                  { id: "inspect", label: "Inspect cell" },
                  { id: "history", label: "Lihat history" },
                ]}
              ...
              <Button onClick={() => setInspectorOpen(true)} variant="secondary">
                Inspector
              </Button>
      ...
      <section className="ds-section" aria-labelledby="feedback-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="feedback-title">
              Feedback & states
            </h2>
            <p className="ds-section__description">
              Blocking error dekat sumbernya; toast hanya transient feedback.
            </p>
          </div>
        </div>
        <div className="ds-grid">
          <div className="ds-card">
            <div className="ds-stack">
              <Banner tone="warning" title="Payroll dirty">
                Source schedule berubah setelah kalkulasi.
              </Banner>
              <InlineValidation title="Minimum rest belum terpenuhi." tone="danger" />
              <Toast tone="success" title="Perubahan tersimpan">
          ...
          <div className="ds-card">
            <EmptyState
              description="Tidak ada request yang membutuhkan tindakan."
              title="Inbox operasional bersih"
            />
          </div>
          <div className="ds-card">
            <ErrorState
              actionLabel="Coba lagi"
              description="Data gagal dimuat. Perubahan lokal belum dikirim."
      ...
      <section className="ds-section" aria-labelledby="data-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="data-title">
              Dense operational data
            </h2>
            <p className="ds-section__description">
              Numeric alignment dan scanability adalah first-class.
            </p>
          </div>
        </div>
        <div className="ds-grid">
            ...
            <DataTable caption="Payroll preview · Agustus 2026">
              <thead>
                <tr>
                  ...
                  <HeadCell align="center" sticky>
                    S2
                  </HeadCell>
                  <HeadCell align="center" sticky>
                    S3
                  </HeadCell>
                  <HeadCell align="right" sticky>
                    Base salary
                  </HeadCell>
                  <HeadCell align="right" sticky>
                    THP
      ...
      <section className="ds-section" aria-labelledby="schedule-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="schedule-title">
              Calendar & schedule semantics
            </h2>
            <p className="ds-section__description">
              Today ≠ selected; OFF ≠ unassigned; validation tetap punya explanation cue.
            </p>
          </div>
        </div>
        <div className="ds-grid">
      ...
      <section className="ds-section" aria-labelledby="history-title">
        <div className="ds-section__header">
          <div>
            <h2 className="ds-section__title" id="history-title">
              Human-readable history
            </h2>
            <p className="ds-section__description">
              Audit payload mentah bukan default human view.
            </p>
          </div>
        </div>
        <div className="ds-grid">
      ...
      <Drawer
        description="Context di belakang tetap terlihat."
      ...
      <Inspector
        description="Detail kontekstual tanpa memindahkan user dari workspace."
      ...
      <BottomSheet
        ...
        footer={
          <Button onClick={() => setSheetOpen(false)} variant="primary">
            Tutup
          </Button>
        }
